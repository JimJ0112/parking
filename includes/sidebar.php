            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="manage-incomingvehicle.php">Manage Incoming Vehicles</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="manage-parkedvehicle.php">Manage Parked Vehicles</a>
                            <li><i class="menu-icon fa fa-th"></i><a href="manage-outgoingvehicle.php">Manage Outgoing Vehicles</a>
